                                ...
                                <td class="content-cell"
                                    ...
                                    @if(count($stockTickers) > 0)
                                        <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Please find the stock latest prices below.
                                        </p>

                                        <table class="action" class="table-striped" align="center" width="100%"
                                            ...
                                            @foreach($stockTickers as $stockTicker)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $stockTicker->changesPercentage }} @if($stockTicker->changesPercentage > 0) &#8593; @else &#8595; @endif
                                                    </td>
                                                    <td>
                                                        {{ $stockTicker->date }}
                                                    </td>
                                    ...
                                    @else
                                        <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            ** There are no updates yet, Updates will be available after 22:00 UTC **
                                        </p>
                                    @endif
                                </td>
                            </tr>
